  ...
  * {
  ...
  svg {
    ...
    max-width: 24px;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./packages","files":"**/*.stories.[tj]s","importPathMatcher":"^\\.[\\\\/](?:packages(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(?:\\[tj\\]|[tj])s)$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:5002/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-node_modules_pnpm_storybook_core-client_6_5_15_react-dom_16_14_0_react_16_14_0_typesc-f1cdca.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>